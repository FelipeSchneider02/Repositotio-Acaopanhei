...
from services import dados_pets, apagar_pet


class PetDeleteView(ctk.CTkToplevel):
    def __init__(self, master, id_pet_delete, *args, **kwargs):
        super().__init__(*args, **kwargs)  # inicializa tela Main
        self.master = master
        self.id_pet_delete = id_pet_delete
    ...
    def pegar_infos(self):
        ...
        dados = dados_pets(self.id_pet_delete)
    ...
    def widgets_view(self):
        ...
        # labels
        pet_label = ctk.CTkLabel(tela_frame, text="DADOS DO PET A SER DELETADO",
        ...
        info_label = ctk.CTkLabel(tela_frame, text="Tem certeza que deseja deletar o pet?",
